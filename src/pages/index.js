    ...
    return (
      <HomepageWrapper>
        <Layout theme="white" bigFooter openContactPopup={this.openContactPopup}>
          <AboveFold>
            <Img fluid={data.avatarHomepage.childImageSharp.fluid} alt="Aleksandar Okiljevic" className="avatar" />
            <t.H1 primary align="center">
              Aleksandar Okiljevic
            </t.H1>
            <t.LargeP align="center" max45>
             Web and React Native devfrom Novi Sad,
             love to code the creative products
            </t.LargeP>
